...
export function VisionRegressionLab() {
  ...
  const copy = locale === "en"
    ? {
        ...
        legendDraft: "Project-agent annotation draft · not TwelveLabs",
        legendModel: "MediaPipe model output · BlazeFace + EfficientDet",
    ...
    : {
        ...
        legendTitle: "框线图例",
        legendDraft: "项目代理初标 · 不是 TwelveLabs 输出",
        legendModel: "MediaPipe 模型输出 · BlazeFace + EfficientDet",
